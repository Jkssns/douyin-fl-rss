const fs = require('fs');
console.log('11: ', {"ip_location":"辽宁","following_count":159,"follower_count":52,"favoriting_count":1610});
const item = JSON.parse('{"ip_location":"辽宁","following_count":159,"follower_count":52,"favoriting_count":1610}');
